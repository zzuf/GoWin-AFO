...
// IsOfflineFilesStartAvailable reports whether the optional export resolves safely.
func IsOfflineFilesStartAvailable() bool { return procOfflineFilesStart.Available() }
